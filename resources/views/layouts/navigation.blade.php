                    ...
                    <div id="nav-ul-li">
                        <ul id="ul">
                            <div id="ul1" style="display: flex; align-items: center;">
                                ...
                                <li>
                                    <a href="{{ route('home') }}" class="element_a" tooltip="Publicar noticia" flow="down">
                                    ...
                                    <div class="dropdown-menu w-100 dropmenu2" style="" aria-labelledby="dropdownMenuButton" role="menu">
                                        <div class="dropmenu3">
                                            <div class="bg-primary w-100" style="margin-right: -1rem !important;">
                                                <li>
                                                    <a href="{{ route('productos.create') }}" class="element_a" tooltip="Productos">
                                            ...
                                            <div class="bg-primary w-100" style="margin-right: -1rem !important;">
                                                <li>
                                                    <a href="{{ route('home') }}" class="element_a" tooltip="Pedidos">
                                                        <i class="fa-regular fas fa-scale-balanced"></i>
                                                    </a>
                                                </li>
                                            </div>
                                        </div>
                            ...
                            <div style="display: flex; align-items: center;" id="ul3">
                                <div class="dropdown" >
                                    ...
                                    <div class="dropdown-menu w-100 dropmenu2" style="" aria-labelledby="dropdownMenuButton" role="menu">
                                        <div class="dropmenu3">
                                            <div class="bg-primary w-50 dropmenu4" style="margin-right: 2rem !important;">
                                                <li>
                                            ...
                                            <div class="bg-primary w-50 dropmenu5" style="margin-right: 2rem !important;">
                                                <li>
